...
class SensorData:
    motor1_measured_freq: float # Etu Paarpuuri
    motor3_measured_freq: float # Taka Paarpuuri 
    motor4_measured_freq: float  # Etu Styyrpuuri
    motor6_measured_freq: float  # Taka Styyrpuuri
